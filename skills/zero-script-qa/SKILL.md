...
- OpenCode analyzes in real-time
...
# Start log monitoring (OpenCode monitors)
docker compose logs -f
```
...
### 3. OpenCode Log Analysis
```
OpenCode in real-time:
...
│  2. AI monitors logs in real-time                           │
│  3. Record pass/fail results                                │
│  4. AI identifies root cause of failures                    │
