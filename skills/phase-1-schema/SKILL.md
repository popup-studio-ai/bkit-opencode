...
**Explaining business terms to AI every time is tedious**.
Creating a glossary allows:
- AI to automatically reference for context understanding
...
To have AI automatically reference the glossary:

**Method 1**: Include in opencode.jsonc
```markdown
## Term Reference
For this project's term definitions, see `docs/01-plan/glossary.md`.
```

**Method 2**: Add term rules to project opencode.jsonc
```markdown
