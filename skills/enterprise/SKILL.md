...
3. Create opencode.jsonc config (Level: Enterprise specified)
...
2nd Priority: opencode.jsonc / Convention docs
  - services/opencode.jsonc
  - frontend/opencode.jsonc
  - infra/opencode.jsonc
...
### opencode.jsonc Hierarchy

```
project/
├── opencode.jsonc           # Project-wide context
├── frontend/opencode.jsonc  # Frontend conventions
├── services/opencode.jsonc  # Backend conventions
└── infra/opencode.jsonc     # Infra conventions
```

Rule: Area-specific opencode.jsonc overrides project-level rules
...
| developer | backend-expert, frontend-architect, baas-expert | Do, Act |
| qa | qa-strategist, qa-monitor, gap-detector | Check |
| reviewer | code-analyzer, design-validator | Check, Act |
| security | security-architect | Design, Check |
