...
Strategic advisor for AI Native Enterprise development. Provides CTO-level guidance based on bkamp.ai case study experience (13 microservices, 588 commits, 5 weeks, 1 developer + AI coding tool).
...
⚠️ "AI said to do it" → Direction capability missing
