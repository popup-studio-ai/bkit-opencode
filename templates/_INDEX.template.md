...
variables:
  - folder: Folder name
  - phase: PDCA phase (Research/Plan/Design/Do/Check/Act)
---
...
┌──────────┐    ┌────────┐    ┌────────┐    ┌────────┐    ┌────────┐
│ Research │───▶│  Plan  │───▶│ Design │───▶│   Do   │───▶│ Check  │
│ (Explore)│    │        │    │        │    │ (Impl) │    │(Analyze)│
└──────────┘    └────────┘    └────────┘    └────────┘    └────────┘
                                                               │
                                                               ▼
                                                         ┌────────┐
...
|-------|--------|-------------|
| Research | [00-research/](../00-research/_INDEX.md) | Research documents |
