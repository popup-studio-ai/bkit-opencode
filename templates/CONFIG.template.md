...
```
AI automatically applies PDCA methodology.
...
2nd: opencode.jsonc / Convention docs
...
AI: 1. Check docs/02-design/ → Create design if missing
...
```
AI: 1. Compare code with design documents
...
**Generated by**: /opencode-learning setup
